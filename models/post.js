    ...
    mongodb.open(function (err, db) {
        ...
        db.collection('posts', function (err, collection) {
            ...
            collection.find(query).sort({ time: -1 }).toArray(function (err, docs) {
                ...
                /*
                e.g:
                [ { _id: 5c441cd1d2b7c93f8c3acde3,
                    user: '213',
                    post: '2313',
                    time: 2019-01-20T07:01:37.328Z },
                { _id: 5c441cc4b273d056e45a5b74,
                    user: '213',
                    post: '3213',
                    time: 2019-01-20T07:01:24.355Z } ]
                */
                docs.forEach(function (doc, index) {
                    // e.g:post : Post { user: '213', post: '3213', time: 2019-01-20T07:01:24.355Z }
